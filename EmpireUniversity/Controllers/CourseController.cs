...
namespace EmpireUniversity.Controllers
{
    public class CourseController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="CourseID,CourseCode,CourseName,CourseCredit,CourseDescription,Semester")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="CourseID,CourseCode,CourseName,CourseCredit,CourseDescription,Semester")] Course course)
        {
            if (ModelState.IsValid)
            {
